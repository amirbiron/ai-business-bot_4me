...
- [ ] עריכת פרומפט עסקי מותאם דרך פאנל האדמין → "הגדרות בוט" — זהות, סגנון, דוגמאות שיחה וכללי התנהגות (אופציונלי, ברירת מחדל נטענת עם --seed)
...
- [ ] הגדרות בוט — בחירת טון תקשורת, הזנת ביטויים מותאמים, עריכת פרומפט עסקי מותאם, תצוגה מקדימה של הפרומפט
